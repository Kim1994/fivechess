...
BEGIN_MESSAGE_MAP(CfivechessApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CfivechessApp::OnAppAbout)
	// 基于文件的标准文档命令
...
CfivechessApp::CfivechessApp()
{
	...
	SetAppID(_T("fivechess.AppID.NoVersion"));

	// TODO:  在此处添加构造代码，
	// 将所有重要的初始化放置在 InitInstance 中
}

// 唯一的一个 CfivechessApp 对象
...
int CfivechessApp::ExitInstance()
{
	//TODO:  处理可能已添加的附加资源
	AfxOleTerm(FALSE);
